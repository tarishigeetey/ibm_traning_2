...
public class FlightController {
	...
	public String findCarrierByName(@RequestParam String carrier,Map<String, List<Flight>> model){
		List<Flight> car = repo.findByCarrier(carrier);
	    model.put("flights", car);
		return "showflights";
	}
}
